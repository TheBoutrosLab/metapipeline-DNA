...
include { call_gSV } from "${moduleDir}/call_gSV/workflow" addParams( this_pipeline: 'call-gSV' )
include { call_sSV } from "${moduleDir}/call_sSV/workflow" addParams( this_pipeline: 'call-sSV' )
include { call_sCNA } from "${moduleDir}/call_sCNA/workflow" addParams( this_pipeline: 'call-sCNA' )
include { call_SRC } from "${moduleDir}/call_SRC/workflow" addParams( this_pipeline: 'call-SRC')
include { stable_lift } from "${moduleDir}/StableLift/workflow" addParams( this_pipeline: 'StableLift' )
include { annotate_VCF } from "${moduleDir}/annotate_VCF/workflow" addParams( this_pipeline: 'annotate-VCF' )
include { call_GeneticAncestry } from "${moduleDir}/call_GeneticAncestry/workflow" addParams( this_pipeline: 'call-GeneticAncestry' )
include { calculate_mtDNA_CopyNumber } from "${moduleDir}/calculate_mtDNA_CopyNumber/workflow" addParams( this_pipeline: 'calculate-mtDNA-CopyNumber' )
